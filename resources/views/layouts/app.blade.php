...
<head>
    ...
    <title>@yield('title', 'CFTMS Cargo and Freight Tracking Management System')</title>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('css/colethaPublicHeader.css') }}" rel="stylesheet">
    <link href="{{ asset('css/colethaPublicFooter.css') }}" rel="stylesheet">

    <link href="{{ asset('css/colethaAuth.css') }}" rel="stylesheet">
    @stack('critical-head')
    @stack('styles')
    <style>
        :root {
...
<body class="has-fixed-footer d-flex flex-column min-vh-100" data-disable-navigation-overlay="1" data-inline-spinner-links="1" data-inline-spinner-theme="blue">
    ...
    <!-- Custom JS -->
    <script src="{{ asset('js/colethaPublicHeader.js') }}"></script>
