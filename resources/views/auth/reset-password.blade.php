            ...
            <div class="auth-login-shell">
                <aside class="auth-login-brand-panel">
                    ...
                    <div class="auth-login-copy">
                        ...
                        <p>Create a fresh password for your cargo management account to continue accessing the system securely.</p>
                    </div>
                    ...
                    <div class="auth-login-guide">
                        ...
                        <ul>
                            ...
                            <li>Combine letters, numbers, and symbols for account security.</li>
                            <li>Confirm the password before saving to complete the reset.</li>
                        </ul>
                    </div>
                ...
                <div class="auth-login-form-panel">
                    <div class="auth-login-form-card">
                        ...
                        <p class="auth-login-subtitle">Update your password to regain secure access to the cargo management dashboard.</p>
