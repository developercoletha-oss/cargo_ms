...
<aside class="auth-brand-panel">
    <a href="{{ route('home') }}" class="auth-brand-mark">
        <img src="{{ asset('img/MYLOGO.png') }}" alt="CFTMS Logo" style="width: 48px; height: 48px; border-radius: 8px;">
        <span class="auth-brand-copy">
            <strong>CFTMS-KIT</strong>
            <span>CFTMS Cargo and Freight Tracking Management System</span>
        </span>
    </a>
